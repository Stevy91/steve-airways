                    ...
                    <div className="fixed inset-0 z-50">
                        ...
                        >
                            <div className="relative w-full max-w-3xl overflow-hidden rounded-3xl bg-gradient-to-br from-white via-white to-slate-50 shadow-2xl shadow-slate-900/30 ring-1 ring-white/50">
                                {/* En-tête avec gradient vert pour création/édition */}
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h2 className="text-2xl font-bold text-white">
                                                    {editingFlight ? "Update Flight" : "Create New Flight"}
                                                </h2>
                                                <div className="mt-2 flex items-center gap-2">
                                                    <div className="rounded-full bg-white/20 px-3 py-1">
                                                        <span className="text-sm font-semibold text-white">
                                                            {editingFlight ? "Edit Mode" : "Creation Mode"}
                                                        </span>
                                                    </div>
                                                    {editingFlight && (
                                ...
                                <form
                                    onSubmit={async (e) => {
                                        ...
                                        const priceEco = Number(formData.get("price_economy")) || 0;
                                        const priceBiz = formData.get("price_business") ? Number(formData.get("price_business")) : null;
                                        const priceFirst = formData.get("price_first") ? Number(formData.get("price_first")) : null;
                                        const flightData = {
                                            ...
                                            total_seat: Number(formData.get("seats_available")),
                                        };
                                ...
                                >
                                    ...
                                    <div className="mb-8 rounded-2xl bg-gradient-to-r from-slate-50 to-white p-6 shadow-lg ring-1 ring-slate-200/50">
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            {/* Numéro de vol */}
                                            <div className="group">
                                                <label className="mb-2 block text-sm font-semibold text-slate-700">Flight Number</label>
                                            ...
                                            {/* Numéro de queue */}
                                            <div className="group">
                                                <label className="mb-2 block text-sm font-semibold text-slate-700">Tail Number</label>
                                                <div className="relative">
                                                    <input
                                                        type="text"
                                                        name="airline"
                                                    ...
                                                    />
                                                    <div className="absolute left-4 top-1/2 -translate-y-1/2">
                                                        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-teal-400 to-teal-500 p-1">
                                                            <svg
                                                                className="h-4 w-4 text-white"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                    ...
                                    <div className="mb-8 rounded-2xl bg-gradient-to-r from-slate-50 to-white p-6 shadow-lg ring-1 ring-slate-200/50">
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            ...
                                            {/* Tarifs par classe — span 2 colonnes */}
                                            <div className="md:col-span-2">
                                                <div className="rounded-xl border border-slate-200 bg-gradient-to-r from-amber-50 to-yellow-50 p-5 shadow-sm">
                                                    ...
                                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                                        ...
                                                        <div>
                                                            <label className="mb-1.5 flex items-center gap-1.5 text-xs font-semibold text-slate-600">
                                                                <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 text-blue-600 text-xs">É</span>
                                                                Économie <span className="text-red-400">*</span>
                                                            </label>
                                                            <div className="relative">
                                                                ...
                                                                <input
                                                                    ...
                                                                    name="price_economy"
                                                                    placeholder="0.00"
                                                                    defaultValue={(editingFlight as any)?.price_economy ?? editingFlight?.price ?? ""}
                                                                    min="0"
                                                                    step="0.01"
                                                                    className="w-full rounded-xl border border-blue-200 bg-white px-4 py-2.5 pl-8 text-slate-700 shadow-sm transition-all focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/30"
                                                                    required
                                                                />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            <label className="mb-1.5 flex items-center gap-1.5 text-xs font-semibold text-slate-600">
                                                                <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-purple-100 text-purple-600 text-xs">B</span>
                                                                Business
                                                            </label>
                                                            <div className="relative">
                                                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-medium text-sm">$</span>
                                                                <input
                                                                    ...
                                                                    name="price_business"
                                                                    placeholder="0.00"
                                                                    defaultValue={(editingFlight as any)?.price_business ?? ""}
                                                                    min="0"
                                                                    step="0.01"
                                                                    className="w-full rounded-xl border border-purple-200 bg-white px-4 py-2.5 pl-8 text-slate-700 shadow-sm transition-all focus:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400/30"
                                                                />
                                                            </div>
                                                        </div>
                                                        {/* Première classe */}
                                                        <div>
                                                            ...
                                                            <div className="relative">
                                                                ...
                                                                <input
                                                                    ...
                                                                    name="price_first"
                                                                    placeholder="0.00"
                                                                    defaultValue={(editingFlight as any)?.price_first ?? ""}
                                                                    min="0"
                                                                    step="0.01"
                                                                    className="w-full rounded-xl border border-amber-200 bg-white px-4 py-2.5 pl-8 text-slate-700 shadow-sm transition-all focus:border-amber-400 focus:outline-none focus:ring-2 focus:ring-amber-400/30"
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p className="mt-3 text-xs text-slate-400">Business et Première Classe sont optionnels. Si vides, le tarif Économie sera utilisé par défaut.</p>
                                                </div>
                                            </div>

                                            {/* Nombre de sièges */}
                                            <div className="group">
                                                <label className="mb-2 block text-sm font-semibold text-slate-700">Available Seats</label>
                                                <div className="relative">
                                                    <input
                                                        type="number"
                                                ...
                                                <span className="flex items-center justify-center gap-3">
                                                    {submitting ? (
                                                        <>
                                                            ...
                                                            {editingFlight ? "Updating Flight..." : "Creating Flight..."}
                                                        </>
                                                    ) : (
                                                        <>
                                                            {editingFlight ? (
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="text-sm text-emerald-700">
                                                        <span className="font-semibold">Note:</span> All times are in local timezone. The arrival time
                                                        must be after the departure time. Seat availability will be automatically updated as
                                                        passengers book.
                                                    </p>
                                                </div>
                                            </div>
