...
export default function BookingCreatedDashboard({ onSearch }: BookingFormProps) {
                        ...
                        <>
                            ...
                            >
                                <div className="sm:md-6 absolute z-[40] flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <div className="mt-[-150px] flex cursor-pointer items-center rounded-full bg-gray-200 px-4 py-2 font-bold text-blue-900 md:mt-[-130px]">
                                        <div
                                            className="relative"
                                            ref={dropdownRef}
                                        >
                                            ...
                                            >
                                                <UserIcon className="mr-2 h-4 w-4 text-blue-900" />
                                                ...
                                                <ChevronDown className="ml-2 h-4 w-4 text-blue-900" />
                                            </div>
                                ...
                                {selectedTabTrip === "onway" ? (
                                    <div className="mb-6 mt-40 grid grid-cols-1 gap-4 sm:grid-cols-2 md:mt-20 md:grid-cols-3">
                                        <div>
                                            ...
                                            {errors.departure && <p className="mt-1 text-xs text-red-900">{errors.departure}</p>}
                                        </div>
                                        <div>
                                            ...
                                            {errors.destination && <p className="mt-1 text-xs text-red-900">{errors.destination}</p>}
                                        </div>
                                        <div className="relative">
                                            <label className="mb-1 block font-medium text-gray-600">Date</label>
                                            <div className="flex items-center rounded-full border p-2">
                                                <CalendarIcon className="mr-2 h-4 w-4 text-red-900" />
                                            ...
                                            {errors.date && <p className="mt-1 text-xs text-red-900">{errors.date}</p>}
                                        </div>
                                    </div>
                                ) : (
                                    <div className="mb-6 mt-40 grid grid-cols-1 gap-4 sm:grid-cols-2 md:mt-20 md:grid-cols-3">
                                        <div>
                                            ...
                                            {errors.departure2 && <p className="mt-1 text-xs text-red-900">{errors.departure2}</p>}
                                        </div>
                                        <div>
                                            <label className="mb-1 block font-medium text-gray-600">{t("To")}</label>
                                            <div className="flex items-center rounded-full border p-2">
                                            ...
                                            {errors.destination2 && <p className="mt-1 text-xs text-red-900">{errors.destination2}</p>}
                                        </div>
                                        <div className="relative">
                                            ...
                                            {errors.date2 && <p className="mt-1 text-xs text-red-900">{errors.date2}</p>}
                                        </div>
                                        <div className="relative">
                                            ...
                                            {errors.returnDate && <p className="mt-1 text-xs text-red-900">{errors.returnDate}</p>}
                                        </div>
                                    </div>
                                )}
                        ...
                        <>
                            ...
                            >
                                ...
                                <button
                                    onClick={handleSearch}
                                    type="submit"
                                    className="mt-6 w-60 rounded-md bg-red-900 py-3 font-semibold text-white hover:bg-red-700"
                                >
