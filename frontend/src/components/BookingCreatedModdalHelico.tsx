                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    ...
                    >
                        <div className="relative w-full max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-br from-white via-white to-slate-50 shadow-2xl shadow-slate-900/30 ring-1 ring-white/50">
                            {/* En-tête avec gradient amber pour création de ticket */}
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                            ...
                                            {showDropdown && suggestions.length > 0 && (
                                                ...
                                                >
                                                    {suggestions.map((p) => (
                                                        ...
                                                        >
                                                            <div className="to-amberd-200 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-amber-100">
                                                                <span className="text-ambert-700 text-xs font-semibold">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="relative">
                                            ...
                                            />
                                            <div className="absolute left-4 top-1/2 -translate-y-1/2">
                                                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-indigo-400 to-indigo-500 p-1">
                                                    <svg
                                                        className="h-4 w-4 text-white"
                                                        fill="none"
                                                        viewBox="0 0 24 24"
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="rounded-xl border border-amber-100 bg-gradient-to-r from-amber-50 to-indigo-50 p-4">
