...
const FlightTable = () => {
    ...
    useEffect(() => {
        const fetchFlights = async () => {
            try {
                ...
                const response = await fetch("http://localhost:3003/flighttablehelico");
    ...
    const handleAddFlight = async (flightData: any) => {
        try {
            ...
            const updatedResponse = await fetch("http://localhost:3003/flighttablehelico"); // Changé le endpoint
